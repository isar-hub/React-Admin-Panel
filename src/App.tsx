        ...
        <Routes>
          <Route element={<AuthLayout />}>
            <Route path="/" element={<MainLayout />}>
              ...
              <Route path="/attendance" element={<Products />} />
              <Route path="/attendance/:productId" element={<ProductEdit />} />
              <Route path="/orders" element={<BlankPage />} />
              <Route path="/leaves" element={<BlankPage />} />
              <Route path="/roles" element={<BlankPage />} />
              <Route path="/zones" element={<BlankPage />} />
            </Route>
          </Route>
